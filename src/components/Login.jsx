    ...
    return (
        <div>
            ...
            <form onSubmit={(e) => e.preventDefault()} className='w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white bg-opacity-80 rounded-lg'>
                ...
                {!isSignInForm && <input ref={name} type="text" placeholder='Name' className='p-4 my-2 w-full bg-gray-700 rounded-lg bg-opacity-50' />}
                <input ref={email} type="text" placeholder='Email Address' className='p-4 my-2 w-full bg-gray-700 rounded-lg bg-opacity-50 ' />
                <input ref={password} type="password" placeholder='Password' className='p-4 my-2 w-full bg-gray-700 rounded-lg bg-opacity-50' />
